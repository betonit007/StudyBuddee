            ...
            <Row>
              ...
              {this.state.rightScreen ? (    
                ...
                <div className="quesWrap">
                  ...
                  <div className="questionCard" style={{width:"600px", margin:"50px auto"}} key={i._id+"div"}>
                  ...
                  <div className="questionCard" style={{width:"600px", margin:"50px auto"}} key={i._id+"divWrong"}>
